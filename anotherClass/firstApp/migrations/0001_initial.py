# Generated by Django 3.1.2 on 2020-11-25 15:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('can_permit', 'Can permit')],
            },
        ),
        migrations.CreateModel(
            name='Level',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', imagekit.models.fields.ProcessedImageField(blank=True, null=True, upload_to='class')),
        ...
        migrations.AddField(
            model_name='class',
            name='like_user',
            field=models.ManyToManyField(blank=True, related_name='like_class', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='class',
            name='mode',
